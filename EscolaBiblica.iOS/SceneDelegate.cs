...
namespace EscolaBiblica.iOS
{
    ...
    public class SceneDelegate : UIResponder, IUIWindowSceneDelegate
    {
        ...
        public UIStoryboard LoginStoryboard => UIStoryboard.FromName("LoginStoryboard", null);
        ...
        public void WillConnect(UIScene scene, UISceneSession session, UISceneConnectionOptions connectionOptions)
        {
            ...
            if (scene is UIWindowScene windowScene)
            {
                ...
                if (!_autenticado)
                {
                    var loginController = LoginStoryboard.InstantiateViewController(nameof(LoginController)) as LoginController;
